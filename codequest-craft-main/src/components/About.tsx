...
const About = () => {
  return (
    <section className="py-16 sm:py-20 md:py-24 px-4 bg-card/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center max-w-6xl mx-auto">
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 pt-4">
              <div className="text-center p-3 sm:p-4 rounded-lg bg-card border border-border">
                <Code2 className="w-6 h-6 sm:w-8 sm:h-8 text-primary mx-auto mb-2" />
                <div className="text-xl sm:text-2xl font-bold text-primary">1</div>
                <div className="text-xs sm:text-sm text-muted-foreground">Ano no mercado</div>
              </div>
              <div className="text-center p-3 sm:p-4 rounded-lg bg-card border border-border">
                <Rocket className="w-6 h-6 sm:w-8 sm:h-8 text-primary mx-auto mb-2" />
                <div className="text-xl sm:text-2xl font-bold text-primary">Startup</div>
                <div className="text-xs sm:text-sm text-muted-foreground">Tecnologia</div>
              </div>
              <div className="text-center p-3 sm:p-4 rounded-lg bg-card border border-border">
                ...
                <div className="text-xs sm:text-sm text-muted-foreground">Fundadores (ADS)</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative order-first lg:order-last">
            <div className="aspect-square rounded-2xl bg-gradient-card border border-border overflow-hidden relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Code2 className="w-20 h-20 sm:w-32 sm:h-32 text-primary/30" />
              </div>
            </div>
          </div>
        </div>
